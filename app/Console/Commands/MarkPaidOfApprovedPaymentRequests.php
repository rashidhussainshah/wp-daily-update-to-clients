...
class MarkPaidOfApprovedPaymentRequests extends Command
{
    use EmailTrait;
     ...
     * @var string
     */
    protected $signature = 'payment:mark-paid-of-approved {user_id} {ccr?}';
     ...
     * @var string
     */
    protected $description = 'Pass user id to approve payment request of a user where status approved and copy payable to paid';
    ...
    public function handle()
    {
        ...
        if (!$upq->isEmpty()) {
            ...
            foreach ($upq as $pq) {
                ...
                $newString = "Approved through command where status is Approved";
