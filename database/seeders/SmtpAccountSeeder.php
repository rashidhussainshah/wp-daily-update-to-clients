...
class SmtpAccountSeeder extends Seeder
{
    public function run(): void
    {
        $accounts = [
            ...
            [
                'name'         => 'Rashid Hussain — rashidhussain@webpenter.com',
                'host'         => 'smtp.titan.email',
                'port'         => 465,
                'encryption'   => 'ssl',
                'username'     => 'rashidhussain@webpenter.com',
                'password'     => 'iampak@786',
                'from_address' => 'rashidhussain@webpenter.com',
                'from_name'    => 'Rashid Hussain',
            ],
            [
                'name'         => 'Zahid Khurshid — zahidkhurshid@webpenter.com',
                'host'         => 'smtp.titan.email',
                'port'         => 465,
                'encryption'   => 'ssl',
                'username'     => 'zahidkhurshid@webpenter.com',
                'password'     => 'iampak@786',
                'from_address' => 'zahidkhurshid@webpenter.com',
                'from_name'    => 'Zahid Khurshid',
            ],
        ];
